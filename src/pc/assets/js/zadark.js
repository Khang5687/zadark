...
(function () {
  ...
  // Windows uses custom HTML notification window (znotification.html)
  // which is handled by CSS in zadark-znotification.js
  // ============================================================
  const isMacOS = navigator.userAgent.indexOf('Mac') !== -1

  if (isMacOS && window.Notification) {
  ...
  const popupFooterHTML = `
    <div class="zadark-popup__footer">
      ...
      <div class="zadark-fork-credit" style="margin-top: 8px; font-size: 11px; color: var(--text-secondary); text-align: center;">
        Forked and modified just a lil bit by duykhang5687@gmail.com
      </div>
    </div>
  `
